...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _79980_archive_1.so
_79980_archive_1.so : archive.81/_79980_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_79980_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_79980_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _88363_archive_1.so
_88363_archive_1.so : archive.162/_88363_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_88363_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_88363_archive_1.so $@

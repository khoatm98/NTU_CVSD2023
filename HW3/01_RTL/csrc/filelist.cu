...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _104505_archive_1.so
_104505_archive_1.so : archive.150/_104505_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_104505_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_104505_archive_1.so $@

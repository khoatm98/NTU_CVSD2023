...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _103015_archive_1.so
_103015_archive_1.so : archive.591/_103015_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_103015_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_103015_archive_1.so $@

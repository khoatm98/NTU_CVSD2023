...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _84524_archive_1.so
_84524_archive_1.so : archive.160/_84524_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_84524_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_84524_archive_1.so $@

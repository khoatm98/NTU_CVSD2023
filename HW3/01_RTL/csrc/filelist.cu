...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _86883_archive_1.so
_86883_archive_1.so : archive.161/_86883_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_86883_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_86883_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _72069_archive_1.so
_72069_archive_1.so : archive.227/_72069_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_72069_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_72069_archive_1.so $@

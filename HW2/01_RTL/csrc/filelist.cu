...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _64543_archive_1.so
_64543_archive_1.so : archive.255/_64543_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_64543_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_64543_archive_1.so $@
